...
Desktop:
![mock-up](assets/images/readme-homepage.png)

Medium device (max width 992px):
![mock-up](assets/images/homepage-max-width-992px.png)

Small device (max width 452px):
![mock-up](assets/images/homepage-max-width-452px.png)
...
### Navigation Bar
![NavBarWide](assets/images/readme-nav-bar-wide.png)
![NavBarNarrow](assets/images/readme-nav-bar-narrow.png)
...
![Home Image](assets/images/england-u21.jpg)
![Home Image](assets/images/c-north.jpg)
![Home Image](assets/images/history-lacrosse2.jpg)
...
![Rules Image](assets/images/women's-field-diagram.jpg)
...
### Validator Testing
Click [here](assets/images/css-validator.png) to see CSS validator for the style.css file.

Click [here](assets/images/html-validator-index.html.png) to see HTML validator for the index.html file.

Click [here](assets/images/html-validator-rules.html.png) to see HTML validator for the rules.html file.

Click [here](assets/images/html-validator-form.html.png) to see HTML validator for the form.html file.
...
Click [here](assets/images/lighthouse-index.html-desktop.png) for index.html.

Click [here](assets/images/lighthouse-rules.html-desktop.png) for rules.html.

Click [here](assets/images/lighthouse-form.html-desktop.png) for form.html.

For Mobile:

Click [here](assets/images/lighthouse-index.html.png) for index.html.

Click [here](assets/images/lighthouse-rules.html.png) for rules.html.

Click [here](assets/images/lighthouse-form.html.png) for form.html.
